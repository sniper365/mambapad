    ...
    render() {
        return (
            <div className="container aboutus">
                <h2 className="col-12 text-center font-weight-bold text-white hero-title">Main Features</h2>
                <div className="row">
                    <div className="col-md-6 mx-3 mx-md-0">
                        <p className="hero-description font-weight-bold">WHAT IS BSCPAD       asdwdwa?</p>
